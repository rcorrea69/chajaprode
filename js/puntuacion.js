$(document).ready(function () {
    ...
    tablaPuntuacion = $("#tablaPuntuacion").DataTable({
        ajax: {
        url: "./ajax/puntuacion.php",
        ...
        {
            defaultContent:
            "<div class='text-center'><div class='btn-group'><button class='btn btn-primary btn-sm btnEditar'><i class='bi bi-eye'></i></button></div></div>",
        },
        ],
        language: {
    ...
    $(document).on("click", ".btnEditar", function () {
        ...
        window.location.href = "otra-jugada.php?usuario="+id;
