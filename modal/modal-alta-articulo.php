        ...
        <form id="form1" name="form1">
          ...
          <div class="form-row">
            ...
            <div class="col-5 form-group">
              ...
              <input type="text" id="articulo" name="articulo" class="form-control" style="text-align: center;" disabled autocomplete="off">
            </div>

            <div class="col-12 form-group">
              <label for="descripcion" class="text-primary">Descripción</label>
              <input type="text" name="descripcion" id="descripcion" class="form-control" placeholder="Descripción" autocomplete="off" required />
            </div>
            <?php
            ...
            <div class="col-5 form-group">
              ...
              <input type="number" name="stock" id="stock" class="form-control" value="0"  step="0.01" style="text-align:right;" />
            </div>

            <div class="col-6 form-group">
              <label for="precio" class="text-primary">Precio Unitario</label>
              <input type="number"  name="precio" id="precio" class="form-control" step="0.01" style="text-align: right;" />
            </div>
            <input type="hidden" name="usu" id="usu" value="<?php echo $usu=$_SESSION['nombre']; ?>"  />
            <?php
