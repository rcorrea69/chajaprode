    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" id="frmInventario" name="frmInventario">
          ...
          <div class="form-group">
            <label for="nombreact" class="control-label">Siguiente Nro</label>
            <input type="text" class="form-control" name="siguiente" id="siguiente" placeholder="Siguiente nro de código" required autocomplete="off" />
          </div>
